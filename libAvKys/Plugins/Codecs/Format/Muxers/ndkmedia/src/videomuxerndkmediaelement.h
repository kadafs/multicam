...
#ifndef VIDEOMUXERNDKMEDIAELEMENT_H
#define VIDEOMUXERNDKMEDIAELEMENT_H

#include <iak/akvideomuxer.h>

class VideoMuxerNDKMediaElementPrivate;

class VideoMuxerNDKMediaElement: public AkVideoMuxer
{
    Q_OBJECT

    public:
        VideoMuxerNDKMediaElement();
        ~VideoMuxerNDKMediaElement();
    ...
    private:
        VideoMuxerNDKMediaElementPrivate *d;
...
#endif // VIDEOMUXERNDKMEDIAELEMENT_H
