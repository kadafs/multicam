...
#ifndef AUDIODEVPIPEWIRE_H
#define AUDIODEVPIPEWIRE_H

#include "audiodev.h"

class AudioDevPipeWirePrivate;

class AudioDevPipeWire: public AudioDev
{
    Q_OBJECT

    public:
        AudioDevPipeWire(QObject *parent=nullptr);
        ~AudioDevPipeWire();
    ...
    private:
        AudioDevPipeWirePrivate *d;

    friend class AudioDevPipeWirePrivate;
};

#endif // AUDIODEVPIPEWIRE_H
