...
#ifndef AKSIMDSSE4_1_H
#define AKSIMDSSE4_1_H

#include <QtGlobal>
#include <smmintrin.h>

#define AKSIMDSSE4_1I32_DEFAULT_SIZE 4
#define AKSIMDSSE4_1I32_ALIGN        16

class AkSimdSSE4_1I32
{
    public:
        using VectorType = __m128i;
        using NativeType = qint32;

        inline AkSimdSSE4_1I32()
        {
        }

        inline size_t size() const
        {
            return AKSIMDSSE4_1I32_DEFAULT_SIZE;
        }
        ...
        {
            return _mm_mul_epi32(a, _mm_set1_epi32(b));
        }
