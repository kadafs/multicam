...
if (WIN32)
    ...
    if (MSVC AND IS_WIN64_TARGET)
        set(NOSIMDMMX ON CACHE BOOL "Disable MMX SIMD optimizations" FORCE)
    endif ()
elseif (UNIX)
    if (ANDROID)
...
function(enable_openmp TARGET)
    ...
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
        target_compile_options(${TARGET} PRIVATE /openmp /openmp:experimental)
    endif ()
endfunction()
