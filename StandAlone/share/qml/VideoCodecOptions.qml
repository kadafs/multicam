...
Dialog {
    ...
    Component {
        ...
        RowLayout {
            ...
            Label {
                text: parent.description
                Layout.minimumWidth: videoCodecOptions.maxSpinLabelWidth
            }
            SpinBox {
                id: spbRange
    ...
    Component {
        ...
        ColumnLayout {
            ...
            function restore() {
                ...
                cisTextField.text = value.width + "x" + value.height
            }

            function reset() {
                cisTextField.text = defaultValue
            }
            ...
            TextField {
                ...
                onTextChanged: {
                    ...
                    parent.controlChanged(parent.key, Qt.size(width, height))
                }
            }
        }
    }
